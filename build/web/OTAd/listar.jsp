<%-- 
    Document   : listar
    Created on : 18 abr. 2021, 14:54:19
    Author     : Andres
--%>
...
<html>
    <head>
        ...
        <title>Listas Ordenes de trabajos</title>
    </head>
    <body>
        ...
        <span class="border">
            ...
            <div class="navbar">
            <a class="btn btn-info" href="ControladorOT?accion=add">Agregar Una Orden</a>
            </div>
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>Ciudad</th>
                        <th>Ubicacion</th>
                        <th>Tipo del Terreno</th>
                        <th>Maquina</th>
                        <th>Acceso Maquina</th>
                        <th>Hectareas</th>
                        <th>Pendientes</th>
                        <th>Calicatas</th>
                        <th>Observaciones</th>
                ...
                <%
                    ...
                    List<OrdenTrabajo> list = dao.listar();
                    Iterator<OrdenTrabajo> iter = list.iterator();
                ...
                <tbody>
                    <tr>
                        ...
                        <td><%= ot.getRegion()%></td>
                        <td><%= ot.getCiudad()%></td>
                        <td><%= ot.getUbicacion()%></td>
                        <td><%= ot.getTipoTerreno()%></td>
                        <td><%= ot.getMaquina()%></td>
                        <td><%= ot.getAccesoMaquina()%></td>
                        <td><%= ot.getHectareas()%></td>
                        <td><%= ot.getPendientes()%></td>
                        <td><%= ot.getCalicatas()%></td>
                        <td><%= ot.getObservaciones()%></td>
                        <td><a class="btn btn-info" href="ControladorOT?accion=editar&IDODT=<%= ot.getIDODT()%>">Editar</a>
                       <a class="btn btn-info" href="ControladorOT?accion=eliminar&IDODT=<%= ot.getIDODT()%>">Eliminar</a>
                       </td>
