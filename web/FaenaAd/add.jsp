    ...
    <body>
        ...
        <span class="border">
            <div class="p-3 mb-2 bg-light text-dark container col-lg-6">
                <div class="col-lg-12">
                    <h1>Agregar Faena</h1>
                    <form name="addfaena" action="ControladorF" class="row g-3">
                        <div class="col-6">
                            Orden de trabajo asociada<br>
                            <select name="txtOTaso"class="form-select" aria-label="Default select example">
                                <option selected>Seleccione Orden de trabajo</option>
                                <%
                        ...
                        <div class="col-6">
                            Nombre Faena<br>
                            <input placeholder="Nombrar a la faena" class="form-control" type="text" name="txtDetalle">
                        </div>
                        <div class="col-6">
                            Maquina
                        ...
                        <div class="col-6">
                            Fecha Inicial<br>
                            <input class="form-control" type="date" name="txtFechaInicial">
                        </div>
                        <div class="col-6">
                            Fecha Final<br>
                            <input class="form-control" type="date" name="txtFechaFinal">
                        </div>
                        <div class="col-12">
                            Observaciones<br>
