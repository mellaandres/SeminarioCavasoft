        ...
        <span class="border">
            <div class="p-3 mb-2 bg-light text-dark container col-lg-6">
                <div class="col-lg-12">
                    ...
                    <form name="addcliente" action="ControladorC" class="row g-3">
                        <div class="col-6">
                            Nombre<br>  
                        ...
                        <div class="col-6">
                            Rut<br>  
                            <input placeholder="Rut sin digito" class="form-control" type="text" name="txtRut">
                        </div>
                        <div class="col-6">
                            Digito Verificador<br>  
                            <input placeholder="Solo digito" class="form-control" type="text" name="txtDvRut">
                        </div>
                        <div class="col-6">
                            Direccion<br>
                            <input placeholder="Ejemplo: Av. pajaritos 123" class="form-control" type="text" name="txtDireccion">
                        </div>
                        <div class="col-6">
                            Correo<br>
                            <input placeholder="Correo electrónico" class="form-control" type="text" name="txtCorreo" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                        </div>
                        <div class="col-12">
                            Teléfono<br>
