        ...
        <span class="border">
            <div class="p-3 mb-2 bg-light text-dark container col-lg-6">
                <div class="col-lg-12">
                    ...
                    <form name="addadmin" action="ControladorAdmin" class="row g-3">  
                        <div class="col-6">
                            Rut<br>
                            <input placeholder="Sin digito verificador" class="form-control" minLength="8" maxlength="8" type="text" name="txtRut" required><br>
                        </div>  
                        <div class="col-6">
                            Digito Verificador<br>
                            <input placeholder="Solo digito verificador" class="form-control" type="text" name="txtDvRut" required><br>
                        </div>
                        <div class="col-6">
                            Nombre<br>  
                            <input placeholder="Nombre" class="form-control" type="text" name="txtNombre" required">
                        </div>
                        <div class="col-6">
                            Apellido<br>  
                            <input placeholder="Apellido" class="form-control" type="text" name="txtApellido" required">
                        </div>
                        <div class="col-6">
                            Correo<br>
                            <input placeholder="Correo electrónico" class="form-control" type="email" name="txtCorreo" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                        </div>
                        <div class="col-6">
                            Teléfono<br>
                            <input placeholder="Agregar el 9 al comienzo" class="form-control" type="text" name="txtTelefono" required pattern="[0-9]{9}">
                        </div>
